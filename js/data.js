...
const WISSEN_FAKTEN = [
  ...
  // ===== v66 — Wissens-Erweiterung =====
  { kategorie:'Körper und Gesundheit', text:'Der Magen produziert alle paar Tage eine neue Schleimschicht — sonst würde er sich selbst verdauen.' },
  { kategorie:'Körper und Gesundheit', text:'Fingernägel wachsen schneller als Fußnägel, und an der Schreibhand schneller als an der anderen.' },
  { kategorie:'Körper und Gesundheit', text:'Babys haben beim Geburtstag noch keine Kniescheiben aus festem Knochen — die bilden sich erst mit den Jahren.' },
  { kategorie:'Körper und Gesundheit', text:'Der Geruchssinn ist eng mit dem Gedächtnis verbunden — Düfte rufen oft starke Erinnerungen wach.' },
  { kategorie:'Körper und Gesundheit', text:'Tränen haben je nach Ursache eine andere Zusammensetzung — Zwiebel-Tränen unterscheiden sich von Trauer-Tränen.' },
  { kategorie:'Körper und Gesundheit', text:'Das menschliche Gehirn verbraucht etwa ein Fünftel der gesamten Energie des Körpers.' },
  { kategorie:'Körper und Gesundheit', text:'Wer ausreichend trinkt, kann sich besser konzentrieren — schon leichter Durst senkt die Aufmerksamkeit.' },
  { kategorie:'Natur und Tiere', text:'Ein Schwarm Stare kann am Himmel Figuren bilden, ohne dass ein einzelner Vogel sie anführt.' },
  { kategorie:'Natur und Tiere', text:'Wale singen Lieder, die sich über Jahre verändern — ganze Gruppen übernehmen neue Melodien.' },
  { kategorie:'Natur und Tiere', text:'Ameisen können das Vielfache ihres eigenen Körpergewichts tragen.' },
  { kategorie:'Natur und Tiere', text:'Sonnenblumen drehen sich als junge Pflanze mit der Sonne mit — ausgewachsen schauen sie meist nach Osten.' },
  { kategorie:'Natur und Tiere', text:'Ein Regenbogen entsteht, weil Wassertropfen das Sonnenlicht in seine Farben zerlegen.' },
  { kategorie:'Natur und Tiere', text:'Pinguine haben eine Drüse, mit der sie Salzwasser trinken und das Salz wieder ausscheiden können.' },
  { kategorie:'Natur und Tiere', text:'Manche Schmetterlinge schmecken mit den Füßen, ob eine Pflanze zum Eierlegen taugt.' },
  { kategorie:'Natur und Tiere', text:'Im Winter fällt der Herzschlag eines Igels im Winterschlaf von rund 180 auf wenige Schläge pro Minute.' },
  { kategorie:'Alltag und Haushalt', text:'Backpulver bindet Gerüche — eine offene Schale im Kühlschrank hält ihn frischer.' },
  { kategorie:'Alltag und Haushalt', text:'Brot bleibt im Brotkasten länger frisch als im Kühlschrank — Kälte lässt es schneller altbacken werden.' },
  { kategorie:'Alltag und Haushalt', text:'Ein tropfender Wasserhahn kann im Jahr mehrere tausend Liter Wasser verschwenden.' },
  { kategorie:'Alltag und Haushalt', text:'Äpfel geben ein Reifegas ab — neben anderem Obst gelagert wird dieses schneller reif.' },
  { kategorie:'Alltag und Haushalt', text:'Wäsche bei 30 statt 60 Grad zu waschen spart deutlich Strom und reicht für normal verschmutzte Kleidung.' },
  { kategorie:'Geschichte und Welt', text:'Die Pyramiden von Gizeh waren über 3.800 Jahre lang die höchsten von Menschen gebauten Bauwerke.' },
  { kategorie:'Geschichte und Welt', text:'Die Deutsche Sprache hat rund 5,3 Millionen Wörter — die meisten davon sind zusammengesetzte Wörter.' },
  { kategorie:'Geschichte und Welt', text:'Der kürzeste Krieg der Geschichte dauerte 1896 nur etwa 38 Minuten.' },
  { kategorie:'Geschichte und Welt', text:'Bevor es Uhren gab, richteten sich Menschen nach Sonnenstand, Sternen und Kirchenglocken.' },
  { kategorie:'Geschichte und Welt', text:'Die ältesten bekannten Höhlenmalereien sind über 40.000 Jahre alt.' },
  { kategorie:'Weltall', text:'Auf der Venus dauert ein Tag länger als ein ganzes Venus-Jahr.' },
  { kategorie:'Weltall', text:'Im Weltall gibt es keinen Schall — ohne Luft können sich Töne nicht ausbreiten.' },
  { kategorie:'Weltall', text:'Das Licht der Sonne braucht rund acht Minuten bis zur Erde.' },
  { kategorie:'Weltall', text:'Ein Löffel Materie eines Neutronensterns würde auf der Erde Milliarden Tonnen wiegen.' },
  { kategorie:'Weltall', text:'Der Mond entfernt sich jedes Jahr ein paar Zentimeter von der Erde.' },
  { kategorie:'Technik und Zahlen', text:'Das @-Zeichen in E-Mail-Adressen wurde 1971 zum ersten Mal für diesen Zweck verwendet.' },
  { kategorie:'Technik und Zahlen', text:'QR-Codes funktionieren auch, wenn ein Teil beschädigt ist — sie enthalten Reserve-Informationen.' },
  { kategorie:'Technik und Zahlen', text:'Die Tastatur-Anordnung „QWERTZ" stammt noch aus der Zeit mechanischer Schreibmaschinen.' },
  { kategorie:'Technik und Zahlen', text:'Eine Million Sekunden sind etwa 11 Tage — eine Milliarde Sekunden fast 32 Jahre.' },
  { kategorie:'Familie und Lernen', text:'Kinder lernen Sprache am besten durch Zuhören, Vorlesen und echte Gespräche im Alltag.' },
  { kategorie:'Familie und Lernen', text:'Gemeinsame Mahlzeiten ohne Bildschirm stärken nachweislich den Zusammenhalt in der Familie.' },
  { kategorie:'Familie und Lernen', text:'Bewegung an der frischen Luft hilft Kindern beim Einschlafen und beim Lernen.' },
  { kategorie:'Familie und Lernen', text:'Schon kurze feste Rituale — etwa eine Gute-Nacht-Geschichte — geben Kindern Sicherheit.' },
  { kategorie:'Familie und Lernen', text:'Kinder, die früh den Umgang mit Geld üben (Taschengeld), gehen später bewusster damit um.' }
];
